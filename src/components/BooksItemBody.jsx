    ...
    <div className="books-item__content m-auto">
      ...
      >
        ...
        <CardBody>
          ...
          <CardText>
            {books.reading === "true" ? (
              <span><span className="text-muted">Status:</span> Reading</span>
            ) : books.finished === "true" ? (
              <span><span className="text-muted">Status:</span> Finished</span>
            ) : (
              <span><span className="text-muted">Status:</span> Book List</span>
            )}
          </CardText>
