  ...
  return (
    <>
      {APIData.length !== 0 ? (
        ...
        <>
        <h1 className="books-list__empty-message">Tidak ada buku.</h1>
        <p className="books-list__empty-message-text">Silakan Berikan tanda kepada buku yang sedang dibaca.</p>
      </>
      )}
    </>
  );
