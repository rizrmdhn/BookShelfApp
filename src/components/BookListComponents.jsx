...
function BookListComponents() {
  ...
  return (
    <div className="booklist-container container-fluid">
      <h1 className="booklists-title">Book Lists</h1>
      {APIData.length !== 0 ? (
        <CardGroup className="Booklist-card container-fluid">
          {APIData.map((books) => {
            return (
              <div className="book-item" key={books.id}>
                <div className="books-item__content m-auto">
                  <Card
                    className="books-item__card"
                    body
                  >
                    <svg
        ...
        <div className="container">
          <h1 className="m-auto mt-4">Silakan input buku terlebih dahulu</h1>
          <p className="books-list__empty-message m-auto mt-3">
            Tidak ada buku.
          </p>
        </div>
      )}
